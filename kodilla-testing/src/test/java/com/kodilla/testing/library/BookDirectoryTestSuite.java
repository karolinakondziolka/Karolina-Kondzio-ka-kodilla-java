...
public class BookDirectoryTestSuite {
    ...
    private List<Book> generateListOfNBooks(int booksQuantity) {
        ...
        @Test
        public void testListBooksInHandsOfWhenListOfBooks0(){
            //Given
            LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
            List<Book> resultListOfBooks0 = generateListOfNBooks(0);
            LibraryUser libraryUser = new LibraryUser("Jan", "Kowalski", "39873");
        ...
        @Test
        public void testListBooksInHandsOfWhenListOfBooks1(){
            //Given
            LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        ...
        @Test
        public void testListBooksInHandsOfWhenListOfBooks5(){
            //Given
            LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
